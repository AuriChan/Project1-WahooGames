...
{
	const int n = TURRET_FRAME_SIZE_Y;
	const int m = TURRET_FRAME_SIZE_X;
	...
	sprite->AddKeyFrame((int)TurretAnim::IDLE_RIGHT, { 0 ,2*n, m, n });
	sprite->SetAnimationDelay((int)TurretAnim::IDLE_LEFT, ANIM_DELAY);
	sprite->AddKeyFrame((int)TurretAnim::IDLE_LEFT, { 0, 2*n, -m, n });

	sprite->SetAnimationDelay((int)TurretAnim::ATTACK_RIGHT, ANIM_DELAY);
	sprite->AddKeyFrame((int)TurretAnim::ATTACK_RIGHT, { 0, 2 *n, m, n });
	sprite->SetAnimationDelay((int)TurretAnim::ATTACK_LEFT, ANIM_DELAY);
	sprite->AddKeyFrame((int)TurretAnim::ATTACK_LEFT, { 0, 2*n, -m, n });
