...
{
	int i;
	const int n = SLIME_FRAME_SIZE_Y;
	const int m = SLIME_FRAME_SIZE_X;
	...
	sprite->AddKeyFrame((int)SlimeAnim::IDLE_RIGHT, { 0, 3 * n, m, n });
	...
	sprite->AddKeyFrame((int)SlimeAnim::ATTACK_RIGHT, { n, 3 * n, m, n });
	sprite->SetAnimationDelay((int)SlimeAnim::ATTACK_LEFT, SLIME_ANIM_DELAY);
	sprite->AddKeyFrame((int)SlimeAnim::ATTACK_LEFT, { 0, 3 * n, -m, n });
	sprite->AddKeyFrame((int)SlimeAnim::ATTACK_LEFT, { n, 3 * n, -m, n });
