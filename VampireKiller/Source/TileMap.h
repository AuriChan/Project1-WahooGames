...
//BACKGROUND 
	...
	BROKEN_BLACK_RIGHT,COLOR_WINDOW_TOP_LEFT, COLOR_WINDOW_TOP_RIGHT,COLOR_WINDOW_BOTTOM_LEFT, COLOR_WINDOW_BOTTOM_RIGHT, BROKEN_GREY_LEFT, BROKEN_GREY_RIGHT,

//GADGETS
    STAIRS = 110, PINK_DOOR_TOP, PINK_DOOR_MID, PINK_DOOR_BOTTOM, CRUSHER_TOP, CRUSHER_MID, CRUSHER_BOTTOM, CRUSHER_PLATAFORM_MID, CRUSHER_PLATAFOR_LEFT, CRUSHER_PLATAFORM_RIGHT, LADDER_TOP,

//ENTITY

PLAYER = 400, SOLDIER, BAT, SKULL_HEAD, SKULL_TURRET,
HEAD, MEDUSA_BOTTOM_LEFT, MEDUSA_BOTTOM_RIGHT, MEDUSA_MID_LEFT, MEDUSA_MID_RIGHT, MEDUSA_TOP_LEFT, MEDUSA_TOP_RIGHT, MEDUSA,



//OBJECT 
    ITEM_HEART = 200, FIRE, FIRE_FRAME0, FIRE_FRAME1, ITEM_RING, ITEM_MORNINGSTAR_WHIP, ITEM_BATTLE_CROSS, ITEM_HOURGLASS, ITEM_HOLY_WATER, ITEM_MAGIC_STAFF,
	ITEM_BOSS_ORB, ITEM_INVULNERABILITY_ORB, ITEM_CHEST, ITEM_GOLD_KEY, ITEM_SILVER_KEY, ITEM_SPEED_BOOTS, ITEM_SHIELD_A, ITEM_SHIELD_B, ITEM_BLACK_BIBLE, ITEM_WHITE_BIBLE, ITEM_WINGS, ITEM_SILVER_CROSS, ITEM_WHITE_MONEY_BAG, ITEM_BLUE_MONEY_BAG, 
	ITEM_STAGE_MAP, ITEM_HEALTH_ORB, ITEM_GOLD_CROSS, TKEY_1, TKEY_2, TKEY_3, TKEY_4, TKEY_5, CHEST1, CHEST2, CHEST3, CHEST4, CHEST5,

//EXTRA TILES
    FENCE_TOP3 = 250, TREE_HANG_LEAF5, TREE_HANG_LEAF6, BROKEN_CASTLE, WIDE_WINDOW_TOP_LEFT, WIDE_WINDOW_TOP_RIGHT,
	WIDE_WINDOW_LEFT, WIDE_WINDOW_RIGHT, WIDE_WINDOW, RAIL_WALL, BLUE_W_TOP_LEFT, BLUE_W_TOP_RIGT, BLUE_W_BOTTOM_LEFT, 
	BLUE_W_BOTTOM_RIGHT,
