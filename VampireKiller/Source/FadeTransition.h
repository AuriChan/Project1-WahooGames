...
public:
    ...
    void SetScene(int to, int frames_to, const Rectangle& rect);
    void SetScene(int from, int frames_from, int to, int frames_to, const Rectangle& rect);
